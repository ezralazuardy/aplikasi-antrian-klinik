      ...
      <div class="section text-center">
            ...
            <div class="col-md-4">
              <div class="info">
                ...
                <div class="row">
                  ...
                  <div class="col-md-5"><h5 class="description">Berat : <?php echo $value['berat']; ?> Kg</h5></div>
                </div>
              </div>
            </div>
            <div class="col-md-4">
        ...
        <div class="row">
          <div class="col-md-4 ml-auto mr-auto">
            <button class="btn button btn-warning">Cetak</button>
            <button class="btn button btn-success">Export</button>
          </div>
        </div>
      </div>
    </div>
