...
<head>
  ...
  <link rel="icon" type="image/png" sizes="96x96" href="<?php echo base_url('assets/img/favicon.webp'); ?>"> </head>
<body class="profile-page sidebar-collapse">
  ...
  <div class="page-header header-filter" data-parallax="true" style="background-image: url('<?php echo base_url('assets/img/bg.webp'); ?>');"></div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 ml-auto mr-auto">
            <div class="profile">
              <div class="avatar"> <img src="<?php echo base_url('assets/img/user-placeholder.webp'); ?>" alt="Circle Image" class="img-raised rounded-circle img-fluid"> </div>
              <div class="name">
                <h3 class="title">Aplikasi Antrian Klinik</h3>
                <h6 style="margin-top:-20px;">versi 1.0</h6> </div>
            </div>
          </div>
        </div>
