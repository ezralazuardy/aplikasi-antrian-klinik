	...
	<div class="sidebar-scroll">
		<nav>
			<ul class="nav">
				...
				<li><a href="<?php echo base_url('Hubungi/index'); ?>" class="active"><i class="lnr lnr-phone" ></i> <span>Daftar Hubungi</span></a></li>
...
<div class="main">
	<div class="main-content">
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-10">
					<h3 class="page-title">Daftar Hubungi</h3>
				</div>
										...
										foreach ($hubungi as $value) {
											...
											<tr>
												...
												<td align="center">
													...
													<a href="<?php echo base_url('Hubungi/hubungiEdit/'.$id); ?>" class="btn btn-sm btn-warning"><span class="fa fa-pencil"></span></a>
