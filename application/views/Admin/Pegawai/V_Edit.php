						...
						<div class="panel-body">
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									...
									<input id="tanggal-lahir" name="tanggal-lahir" type="text" class="form-control tanggal-lahir" placeholder="Tanggal Lahir" value="<?php echo $value['tanggal_lahir']; ?>" required="">
								</div>
